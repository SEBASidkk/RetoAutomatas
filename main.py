...
NOMBRE_TIPO = {
    ...
    TokenType.MULTIPLICACION: "Multiplicación",
    TokenType.DIVISION:       "División",
    TokenType.POTENCIA:       "Potencia",
    TokenType.PAREN_ABRE:     "Paréntesis que abre",
    TokenType.PAREN_CIERRA:   "Paréntesis que cierra",
